...
public class BluetoothPopUp extends AppCompatActivity {
    ...
    private String connStatus; // variable with bluetooth connection status
    BluetoothAdapter mBluetoothAdapter;
    public ArrayList<BluetoothDevice> mNewBTDevices; // ArrayList of newly discovered devices
    public ArrayList<BluetoothDevice> mPairedBTDevices; // ArrayList of paired devices
    public DeviceListAdapter mNewDevlceListAdapter;
    public DeviceListAdapter mPairedDevlceListAdapter;
    TextView connStatusTextView; // UI Connection status on UI
    ListView otherDevicesListView; // UI Newly discovered devices
        ...
        otherDevicesListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR2) {
                    ...
                    mNewBTDevices.get(i).createBond(); // Pairing
...
//                mBluetoothConnection.startAcceptThread();
    ...
    public void finish() {
        ...
        super.finish(); //Finish this activity as well as all activities immediately below it
    }
}
